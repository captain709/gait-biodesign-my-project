...
for i in tqdm(folder_name):
    ...
    for j, file_name in enumerate(file_location):
        ...
        with open(os.path.join(left_position_foot_to_pelvis_path,i + '_' + Path(file_name).stem + '_'+ "angle"+'_'+'xzyframe' + ".pkl"),"wb") as f :
...
for i in tqdm(folder_name):
    ...
    for j, file_name in enumerate(file_location):
        ...
        # with open(os.path.join(left_angle_path,i + '_' + Path(file_name).stem + '_'+ "angle" + ".pkl"),"wb") as f :
        #     pickle.dump(data_dict_joint_angle,f)
        with open(os.path.join(right_position_foot_to_pelvis_path,i + '_' + Path(file_name).stem + '_'+ "angle"+'_'+'xzyframe' + ".pkl"),"wb") as f :
            pickle.dump(data_dict_velocity,f)
...
for i in tqdm(folder_name):
    ...
    for j, file_name in enumerate(file_location):
        ...
        # with open(os.path.join(left_angle_path,i + '_' + Path(file_name).stem + '_'+ "angle" + ".pkl"),"wb") as f :
        #     pickle.dump(data_dict_joint_angle,f)
        with open(os.path.join(left_velocity_foot_to_pelvis_path,i + '_' + Path(file_name).stem + '_'+ "angle"+'_'+'xzyframe' + ".pkl"),"wb") as f :
            pickle.dump(data_dict_velocity,f)
...
for i in tqdm(folder_name):
    ...
    for j, file_name in enumerate(file_location):
        ...
        # with open(os.path.join(left_angle_path,i + '_' + Path(file_name).stem + '_'+ "angle" + ".pkl"),"wb") as f :
        #     pickle.dump(data_dict_joint_angle,f)
        with open(os.path.join(right_velocity_foot_to_pelvis_path,i + '_' + Path(file_name).stem + '_'+ "angle"+'_'+'xzyframe' + ".pkl"),"wb") as f :
            pickle.dump(data_dict_velocity,f)
