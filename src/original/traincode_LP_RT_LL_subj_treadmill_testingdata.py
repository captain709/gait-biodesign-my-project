...
import re
system="Fold2Validation"#"Fold4Test"

exercise="walking_left"#"walking_right"
...
if(system=="Fold2Validation"):
	import setting06 as setting
elif(system=="Fold2Validation"):
	import setting06 as setting
...
for k in range(4,5):
    for j in range(8):
        dir_loop = 'C:\\Users\\Dollaporn Anopas\\Desktop\\SI\\Research\\Rehab\\Program'+'\\Subj' + str(Fold1[j]) + '\\d1pkl\\walking_left\\'
