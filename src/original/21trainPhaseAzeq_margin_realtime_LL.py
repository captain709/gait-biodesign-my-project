...
with open('C:\\Users\\Dollaporn Anopas\\Desktop\\SI\\Research\\Rehab\\Program\\Walking_LLLTrain\\d1pkl\\walking_left\\sumsample.csv') as csvfile:
    readCSV = csv.reader(csvfile, delimiter=',')
    RatEndNumberPlusOne = []
    for row in readCSV:
        sampleSameRatEnd_plusone = row[0]
        RatEndNumberPlusOne.append(int(float(sampleSameRatEnd_plusone)))
with open('C:\\Users\\Dollaporn Anopas\\Desktop\\SI\\Research\\Rehab\\Program\\Walking_LLLTrain\\d1pkl\\walking_left\\sumtrial.csv') as csvfile2:
...
RatAmount=30#30#42
SessionAmount=1118#1117#239#329 #actually amount of file#this value start from one then need to plus one
...
# 	print("EndRatSessionPlusOne[iColor]")
# 	print(EndRatSessionPlusOne[iColor])
# 	print("EndRatSessionPlusOne[iColor]-2")
# 	print(EndRatSessionPlusOne[iColor]-2)
