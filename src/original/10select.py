...
#gofolder=os.path.join('CSV','SUB2','over_ground','csvOP')#d0ExportSessionProto_recheck
gofolder=os.path.join('csvOP_T','LeftFoot')#d0ExportSessionProto_recheck
# dstfolder1=os.path.join('CSV','SUB2','over_ground',os.path.join('pkl','walking_left'))
# dstfolder2=os.path.join('CSV','SUB2','over_ground',os.path.join('pkl','walking_right'))
dstfolder1=os.path.join('Training_data',os.path.join('pkl','walking_left','LeftFoot','A'))
dstfolder2=os.path.join('Training_data',os.path.join('pkl','walking_right','RightForearm'))
type_walk = 'treadmill' #over_ground treadmill
#NumSub = 'A001'
RightSub = 'R_T'
LeftSub = 'L_T'
...
# dir_path = 'C:\\Users\\NAPATSAWAn\\OneDrive - Srinakharinwirot University\\Desktop\\data\\CSV\\SUB2\\over_ground\\csvOP'
# dir_path = 'C:\\Users\\Dell Precision 3660\\OneDrive - Mahidol University\\Desktop\\data\\csvOP_T\\LeftFoot'
# dir_path = 'C:\\Users\\Dell Precision 3660\\OneDrive - Mahidol University\\Desktop\\data\csvOP_T\\LeftForearm' 
dir_path = 'C:\\Users\\Dell Precision 3660\\Desktop\\data\\csvOP_T\\LeftFoot' 

# dir_path = 'C:\\Users\\Dell Precision 3660\\OneDrive - Mahidol University\\Desktop\\data\csvOP_T\\RightForearm' 
...
exercise = "walking_left" #walking_left ,walking_right
for system in ["pkl"]:#,"walking_forelimb"#"walking_hindlimb"
	...
	for iRat in Ratfile:
		print(iRat)
# 		f1 = open(os.path.join(gofolder,RightSub+str(iRat)+'.csv'), "rt")#new4RF1_norm_rat#Rat5_relativePositionForelimb1_norm_
		f2 = open(os.path.join(gofolder,LeftSub+str(iRat)+'.csv'), "rt")#new4RF2_norm_rat#Rat5_relativePositionForelimb2_norm_
...
#  			print(ans4)
		...
		if(exercise=="walking_left"):
			with open(os.path.join(dstfolder1,(type_walk+str(iRat)+'_walking_left.pkl')), 'wb') as fpickle1:#with open(os.path.join(dstfolder1,('rat'+str(iRat)+'_walking_normal_hindlimb.pkl')), 'wb') as fpickle1:
				#print("pklfile1")
				d={
				'data': ans4,
				}
			...
			with open(os.path.join(dstfolder2,(type_walk+str(iRat)+'_walking_right.pkl')), 'wb') as fpickle2:#with open(os.path.join(dstfolder2,('rat'+str(iRat)+'_walking_normal_forelimb.pkl')), 'wb') as fpickle2:
				#print("pklfile2")
				d={
				'data': ans4,
				}
