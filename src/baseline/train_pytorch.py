...
DATA_DIR = "C:\\Users\\Admin\\Desktop\\peam_biodis_gait\\pkl_peam_test\\position\\LeftFoot\\original"
# DATA_DIR = "../data/Training_data/pkl/walking_left/LeftFoot"
...
dataset_position = pipeline.GaitPhasingDataset(
    data_root=DATA_ROOT,
    data_dir=DATA_DIR_2,
    img_dir=DATA_DIR_2, #velocity
    # end_session_plus_one_path= "C:\\Users\\Admin\\Desktop\\peam_biodis_gait\\EndSessionPlusOne.csv",
    end_session_plus_one_path= "mnt\\ExpDrive\\PeamDrive\\peam_biodesign\\EndSessionPlusOne.csv",  
    windowWing=3,
    regressWing=3,
    predictionGap=1,
    rotationMatrixList=None,
...
SubjectAmount = dataset.SubjectAmount
startNewTraining = True
# sessionFile="C:\\Users\\Admin\\Desktop\\peam_biodis_gait\\result\\test_new_pipe\\" + f"{dataset.trainName}phaseModel.ckpt"
...
sessionFile="C:\\Users\\Admin\\Desktop\\peam_biodis_gait\\result\\reverted_old_pipe\\" + f"{dataset.trainName}phaseModel.ckpt"
imageFolder = "C:\\Users\\Admin\\Desktop\\peam_biodis_gait\\result\\reverted_old_pipe\\img\\"
imageFolderRat = "C:\\Users\\Admin\\Desktop\\peam_biodis_gait\\result\\reverted_old_pipe\\img\\rat\\"
...
centerPose = dataset.AllData["centerPose"][0:2,...]
srcColorList = dataset.AllData["srcColorList"]
srcColorList_rat = dataset.srcColorList_subject

nowState_img = dataset.AllData_img["XY"][0:2,...]
nextState_img = dataset.AllData_img["XY2"][0:2,...]
sessionSegmentMatrix_img = dataset.AllData_img["SessionSegmentMatrix"]
centerPose_img = dataset.AllData_img["centerPose"][0:2,...]
