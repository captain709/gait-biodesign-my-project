...
for speedy in treadmill_speed:
    ...
    fig.savefig(op.join(left_velocity_foot_path, f"Test3_VelocityLeftFoot_x_subplots_{speedy}.png"))
    
    print(f"Plot saved at: {op.join(left_velocity_foot_path, f'Test3_VelocityLeftFoot_x_subplots_{speedy}.png')}")
...
for speedy in treadmill_speed:
    ...
    fig.savefig(op.join(left_velocity_foot_path, f"Test3_VelocityLeftFoot_z_subplots_{speedy}.png"))
    
    print(f"Plot saved at: {op.join(left_velocity_foot_path, f'Test3_VelocityLeftFoot_z_subplots_{speedy}.png')}")
...
for speedy in treadmill_speed:
    ...
    fig.savefig(op.join(left_velocity_hand_path, f"Test3_VelocityLeftHand_x_subplots_{speedy}.png"))
    
    print(f"Plot saved at: {op.join(left_velocity_hand_path, f'Test3_VelocityLeftHand_x_subplots_{speedy}.png')}")
